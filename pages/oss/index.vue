        ...
        <hero className="flex w-full max-w-6xl flex-row items-center justify-between p-8 md:my-16">
            <div className="flex w-full flex-col space-y-8">
                <div className="flex w-full flex-col space-y-4">
                    ...
                    <h2 className="select-none font-poppins text-3xl font-bold text-neutral-900">Introduction</h2>
                    ...
                    <h2 className="select-none font-poppins text-3xl font-bold text-neutral-900">How to Contribute</h2>
                    <p className="select-none font-poppins text-xl text-neutral-900">
                        To access it, head to our <a className="font-bold text-cyan-700" href="https://github.com/femdevs/femdev-website" target="_blank">official website repository</a>
                        and follow our guide on <a className="font-bold text-cyan-700" href="/oss/contributing" target="_blank">how to contribute</a> to our open source repository.
                    </p>
                </div>
            </div>
        </hero>
